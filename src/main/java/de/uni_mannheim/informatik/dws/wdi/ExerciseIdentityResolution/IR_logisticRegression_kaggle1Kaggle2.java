...
public class IR_logisticRegression_kaggle1Kaggle2 {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        gsTraining.loadFromCSVFile(new File("data/goldstandard/kaggle1_kaggle2_train.csv"));
        ...
        matchingRule.activateDebugReport("data/output/debugResultsMatchingRule(Kaggle1Kaggle2_logisticRegression).csv", 1000, gsTraining);
        ...
        blocker.collectBlockSizeData("data/output/debugResultsBlocking(Kaggle1Kaggle2_logisticRegression).csv", 100);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/Kaggle1Kaggle2_correspondences(logisticRegression)s.csv"), correspondences);
