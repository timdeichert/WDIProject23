...
public class IR_linear_kaggle1Kaggle2_Standardblocker {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        LinearCombinationMatchingRule<Game, Attribute> matchingRule = new LinearCombinationMatchingRule<>(
                0.7);
        matchingRule.activateDebugReport("data/output/debugResultsMatchingRule(Kaggle1Kaggle2_Linear_StandardBlocker).csv", 10000, gsTest);
...
//       matchingRule.addComparator(new EmbeddedComparator("src/main/java/de/uni_mannheim/informatik/dws/wdi/ExerciseIdentityResolution/cc.en.300.vec"), 0.1);
        ...
        blocker.collectBlockSizeData("data/output/debugResultsBlocking(Kaggle1Kaggle2_Linear_StandardBlocker).csv", 10000);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/kaggle1_kaggle2_linear_standard_blocker_correspondences.csv"), correspondences);
