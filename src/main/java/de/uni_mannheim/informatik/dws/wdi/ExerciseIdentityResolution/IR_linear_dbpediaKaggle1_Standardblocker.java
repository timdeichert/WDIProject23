...
public class IR_linear_dbpediaKaggle1_Standardblocker {
    /*
     * Logging Options:
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        LinearCombinationMatchingRule<Game, Attribute> matchingRule = new LinearCombinationMatchingRule<>(
                0.7);
        matchingRule.activateDebugReport("data/output/debugResultsMatchingRule(DBpediaKaggle1_Linear_StandardBlocker).csv", 10000, gsTest);
...
//       matchingRule.addComparator(new EmbeddedComparator("src/main/java/de/uni_mannheim/informatik/dws/wdi/ExerciseIdentityResolution/cc.en.300.vec"), 0.1);
        ...
        blocker.collectBlockSizeData("data/output/debugResultsBlocking(DBpediaKaggle1_Linear_StandardBlocker).csv", 10000);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/dbpedia_kaggle1_linear_standard_blocker_correspondences.csv"), correspondences);
