...
public class IR_linear {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        // add comparators
        matchingRule.addComparator(new GameNameComparatorLevenshtein(), 0.5);
        matchingRule.addComparator(new GameNameComparatorJaccard(), 0.5);
