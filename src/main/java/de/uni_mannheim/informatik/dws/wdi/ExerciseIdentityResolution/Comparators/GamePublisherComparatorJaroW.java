...
public class GamePublisherComparator implements Comparator<Game, Attribute> {
    ...
    private JaroWinklerSimilarity sim = new JaroWinklerSimilarity(); // Use Jaro-Winkler similarity
    ...
    public double compare(
        ...
        double similarity = sim.calculate(publisher1, publisher2); // Use Jaro-Winkler similarity
