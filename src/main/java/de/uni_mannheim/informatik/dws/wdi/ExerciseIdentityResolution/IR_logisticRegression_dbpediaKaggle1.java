...
public class IR_logisticRegression_dbpediaKaggle1 {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        matchingRule.activateDebugReport("data/output/debugResultsMatchingRule(DBpediaKaggle1_logisticRegression).csv", 1000, gsTraining);
        ...
        blocker.collectBlockSizeData("data/output/debugResultsBlocking(DBpediaKaggle1_logisticRegression).csv", 100);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/DBpedia_Kaggle1_logisticRegression_correspondences.csv"), correspondences);
