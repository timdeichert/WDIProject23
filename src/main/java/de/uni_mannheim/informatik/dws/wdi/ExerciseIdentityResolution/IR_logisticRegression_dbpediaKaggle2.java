...
public class IR_logisticRegression_dbpediaKaggle2 {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        matchingRule.activateDebugReport("data/output/debugResultsMatchingRule(DBpediaKaggle2_logisticRegression).csv", 1000, gsTraining);
        ...
        blocker.collectBlockSizeData("data/output/debugResultsBlocking(DBpediaKaggle2_logisticRegression).csv", 100);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/DBpediaKaggle2_correspondences(logisticRegression).csv"), correspondences);
