...
public class IR_decisionTree_dbpediaKaggle1 {
    /*
     * Logging Options:
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        blocker.collectBlockSizeData("data/output/debugResultsBlocking(DBpediaKaggle1_decisionTree).csv", 100);
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/DBpedia_Kaggle1_correspondences(DBpediaKaggle1_decisionTree).csv"), correspondences);
