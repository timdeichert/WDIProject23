...
/**
 * {@link EvaluationRule} for the date of {@link Game}s. The rule simply
 * compares the year of the dates of two {@link Game}s.
 * 
 * @author Your Name
 */
public class DateEvaluationRule extends EvaluationRule<Game, Attribute> {
