...
public class IR_decisionTree_kaggle1Kaggle2 {
    /*
     * Logging Options:
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/DBpedia_Kaggle1_correspondences(Kaggle1Kaggle2_decisionTree).csv"), correspondences);
